...
import type { DistributionMessage, MessageChannel, MessageStatus } from "@/lib/types";
...
export default function MessagesPage() {
  const { messages, addMessage, updateMessage, deleteMessage, messageTemplates } = useDashboard();
  ...
  const handleSend = () => {
    ...
    if (editingId) {
      updateMessage(editingId, {
        ...
        subject: formSubject,
        content: formContent,
        status: formDelivery === "scheduled" ? "scheduled" : "sent",
    ...
    <div className="p-8">
      ...
      >
        <div className="space-y-5">
          {/* Template buttons */}
          {!editingId && messageTemplates.length > 0 && (
            <div>
