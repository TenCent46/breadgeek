...
import type { RecipeIngredient, Recipe, Ingredient, Service } from "@/lib/types";
...
export function RecipeEditClient({ recipe, ingredients, services }: RecipeEditClientProps) {
  ...
  const [linkedServiceId, setLinkedServiceId] = useState(recipe.linkedServiceId ?? "");
    ...
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">レシピ編集</h1>
