...
import type { Service, ServiceType, ServiceStatus } from "@/lib/types";
...
export default function ServicesPage() {
  const { services, addService, deleteService, recipes } = useDashboard();
  ...
  function handleDuplicate(service: Service) {
    ...
    addService({ ...rest, title: `${rest.title}（コピー）`, status: "draft" });
  }
