...
import type { ServiceType, ServiceStatus, Recipe } from "@/lib/types";
...
interface ServiceNewClientProps {
  recipes: Recipe[];
}

export function ServiceNewClient({ recipes }: ServiceNewClientProps) {
