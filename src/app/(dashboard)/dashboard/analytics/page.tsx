...
export default function AnalyticsPage() {
  const { services, bookings, customers, sales, kitchenSettings } = useDashboard();
  ...
  const utilizationData = useMemo(() => {
    return publishedServices.map((svc) => {
      const capacity = svc.capacity ?? kitchenSettings.maxCapacity;
  ...
  }, [publishedServices, bookings, kitchenSettings]);
