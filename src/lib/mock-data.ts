...
export const mockBookings: Booking[] = [
  { id: "b1", serviceId: "s1", serviceName: "初心者パンレッスン〜フォカッチャ〜", serviceType: "group-lesson", customerId: "c1", customerName: "田中美咲", customerEmail: "tanaka@example.com", date: "2026-03-01", startTime: "10:00", endTime: "12:30", status: "confirmed", amount: 5500, notes: "", createdAt: "2026-02-20" },
  { id: "b2", serviceId: "s2", serviceName: "クロワッサンマスターコース（全3回）", serviceType: "master-course", customerId: "c2", customerName: "佐藤洋平", customerEmail: "sato@example.com", date: "2026-03-05", startTime: "10:00", endTime: "13:00", status: "confirmed", amount: 18000, notes: "全3回分一括支払い済み", createdAt: "2026-02-21" },
  { id: "b3", serviceId: "s3", serviceName: "はじめてのパン作り体験", serviceType: "trial-lesson", customerId: "c3", customerName: "山田花子", customerEmail: "yamada@example.com", date: "2026-03-02", startTime: "14:00", endTime: "16:00", status: "pending", amount: 3000, notes: "", createdAt: "2026-02-22" },
  { id: "b4", serviceId: "s1", serviceName: "初心者パンレッスン〜フォカッチャ〜", serviceType: "group-lesson", customerId: "c4", customerName: "鈴木大輝", customerEmail: "suzuki@example.com", date: "2026-03-01", startTime: "10:00", endTime: "12:30", status: "confirmed", amount: 5500, notes: "", createdAt: "2026-02-20" },
  { id: "b5", serviceId: "s4", serviceName: "天然酵母パンレッスン", serviceType: "group-lesson", customerId: "c5", customerName: "高橋裕子", customerEmail: "takahashi@example.com", date: "2026-03-10", startTime: "10:00", endTime: "13:00", status: "confirmed", amount: 6500, notes: "卵アレルギーあり", createdAt: "2026-02-23" },
  { id: "b6", serviceId: "s2", serviceName: "クロワッサンマスターコース（全3回）", serviceType: "master-course", customerId: "c6", customerName: "伊藤直子", customerEmail: "ito@example.com", date: "2026-03-05", startTime: "10:00", endTime: "13:00", status: "pending", amount: 18000, notes: "", createdAt: "2026-02-24" },
  { id: "b7", serviceId: "s1", serviceName: "初心者パンレッスン〜フォカッチャ〜", serviceType: "group-lesson", customerId: "c7", customerName: "渡辺翔太", customerEmail: "watanabe@example.com", date: "2026-03-08", startTime: "10:00", endTime: "12:30", status: "confirmed", amount: 5500, notes: "", createdAt: "2026-02-25" },
  { id: "b8", serviceId: "s3", serviceName: "はじめてのパン作り体験", serviceType: "trial-lesson", customerId: "c1", customerName: "田中美咲", customerEmail: "tanaka@example.com", date: "2026-03-15", startTime: "14:00", endTime: "16:00", status: "confirmed", amount: 3000, notes: "友人と参加予定", createdAt: "2026-02-25" },
];
